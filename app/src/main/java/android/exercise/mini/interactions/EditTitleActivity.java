...
public class EditTitleActivity extends AppCompatActivity {
     ...
     */
        ...
        if (this._isEditing) {
            ...
            // show static text-view with previous text
            textViewTitle.setVisibility(View.VISIBLE);
            //animate out done-edit
            fabEditDone.animate()
                    .alpha(0f)
                    .start();
            fabEditDone.setVisibility(View.GONE);
...
//            hideKeyBoard(textViewTitle);
            ...
            System.out.println("BACK button was not pressed");
            super.onBackPressed();
        }
